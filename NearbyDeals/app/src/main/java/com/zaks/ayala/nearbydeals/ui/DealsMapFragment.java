...
public class DealsMapFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Serializable deal = getActivity().getIntent().getSerializableExtra("Deal");
        if (deal != null)
            showDealDialog((Deal) deal);
        return v;
    }
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                if (dealHashMap.containsKey(marker.getId())) {
                    showDealDialog(dealHashMap.get(marker.getId()));
                    return true;
                }
                return true;
            }
    ...
    private void setMapCenter() {
        ...
        mMap.addMarker(new MarkerOptions().position(loc).icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_location)));
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        String selection = CategoriesContract.CategoryEntry.Column_Description
                + " IN ('" + categories + "')";
